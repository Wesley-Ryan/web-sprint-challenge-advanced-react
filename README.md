...
1. Explain how to build stateful class components.
   Stateful class components are built using a constructor and we define our state within that constructor. We can update state with setState and we always have to reference "this"

2. Describe the different phases of the component lifecycle.
   Mounting, Updating, and Unmounting

3. Demonstrate an understanding of class component lifecycle methods.
   Mounting do something , Updating do soemthing only on update/render, and Unmounting do something before you leave.
